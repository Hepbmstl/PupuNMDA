...
primary_branches_cell = 11 // 主分支
branches_cell = 108 // 次分支
max_dx_cell = 7094.47 // 最大段长
points_cell = 1224 // 坐标点
nseg_cell = 206 // 区室
...
name_soma = "soma"
name_section = "dend"
use_axon = 0					/* create sections */ //1个胞体和11个树突分支 分支有多少个区室
create    soma,\
          dend1[1],\
          dend2[3],\
          dend3[13],\
...
{ 
    ...
    soma connect dend1[0] (0), 0.5 // 树突分支区段0 起点 到soma 
